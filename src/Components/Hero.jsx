    ...
    <div className="relative overflow-hidden">
      ...
      >
        <motion.div 
          ...
          initial="hidden"
          animate="visible"
          className="container mx-auto px-4 py-12 flex flex-col lg:flex-row items-center relative z-10"
        >
          {/* Text Content */}
          <div className="w-full lg:w-1/2 text-center lg:text-left mb-12 lg:mb-0 lg:pr-12 mt-10">
            <motion.h1 
            ...
            >
              ...
              <br />
              <span className="text-gray-800 dark:text-gray-200 text-3xl md:text-5xl lg:text-6xl">
